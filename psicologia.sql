...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2025 a las 17:37:36
...
--
ALTER TABLE `consulta`
  ADD CONSTRAINT `Paciente-Consul` FOREIGN KEY (`ID_paciente`) REFERENCES `paciente` (`ID_paciente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Psicologo-Consul` FOREIGN KEY (`ID_psicologo`) REFERENCES `psicologo` (`ID_psicologo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Solicitud-Consul` FOREIGN KEY (`ID_solicitud`) REFERENCES `solicitar_cita` (`ID_solicitud`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `cronograma`
--
ALTER TABLE `cronograma`
  ADD CONSTRAINT `Paciente-Cro` FOREIGN KEY (`ID_paciente`) REFERENCES `paciente` (`ID_paciente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Psicologo-Cro` FOREIGN KEY (`ID_psicologo`) REFERENCES `psicologo` (`ID_psicologo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Usuario-Cro` FOREIGN KEY (`ID_usuario`) REFERENCES `usuario` (`ID_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `direccion`
--
ALTER TABLE `direccion`
  ADD CONSTRAINT `Ciudad-Dir` FOREIGN KEY (`ID_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Estado-Dir` FOREIGN KEY (`ID_estado`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Municipio-Dir` FOREIGN KEY (`ID_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Paciente-Dir` FOREIGN KEY (`ID_paciente`) REFERENCES `paciente` (`ID_paciente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Parroquia-Dir` FOREIGN KEY (`ID_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `empresa`
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `Empresa-Dir` FOREIGN KEY (`ID_direccion`) REFERENCES `direccion` (`ID_direccion`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `factura`
--
ALTER TABLE `factura`
  ADD CONSTRAINT `Empresa-Fact` FOREIGN KEY (`ID_empresa`) REFERENCES `empresa` (`ID_empresa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Pago-Fact` FOREIGN KEY (`ID_pago`) REFERENCES `pago` (`ID_pago`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Solicitud-Fact` FOREIGN KEY (`ID_solicitud`) REFERENCES `solicitar_cita` (`ID_solicitud`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `paciente`
  ADD CONSTRAINT `Direccion-Pacien` FOREIGN KEY (`ID_direccion`) REFERENCES `direccion` (`ID_direccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Usuario-Pacien` FOREIGN KEY (`ID_usuario`) REFERENCES `usuario` (`ID_usuario`);

--
-- Filtros para la tabla `pago`
--
ALTER TABLE `pago`
  ADD CONSTRAINT `Paciente-Pago` FOREIGN KEY (`ID_paciente`) REFERENCES `paciente` (`ID_paciente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Psicologo-Pago` FOREIGN KEY (`ID_psicologo`) REFERENCES `psicologo` (`ID_psicologo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pariente`
--
ALTER TABLE `pariente`
  ADD CONSTRAINT `Paciente-Parient` FOREIGN KEY (`ID_paciente`) REFERENCES `paciente` (`ID_paciente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Usuario-Parient` FOREIGN KEY (`ID_usuario`) REFERENCES `usuario` (`ID_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `psicologo`
  ADD CONSTRAINT `Direccion-Psico` FOREIGN KEY (`ID_direccion`) REFERENCES `direccion` (`ID_direccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Usuario-Psico` FOREIGN KEY (`ID_usuario`) REFERENCES `usuario` (`ID_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `solicitar_cita`
--
ALTER TABLE `solicitar_cita`
  ADD CONSTRAINT `Crono-Solic` FOREIGN KEY (`ID_cronograma`) REFERENCES `cronograma` (`ID_cronograma`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
